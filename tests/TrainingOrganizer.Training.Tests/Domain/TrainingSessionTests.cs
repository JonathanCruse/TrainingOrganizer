...
using TrainingOrganizer.Training.Tests.TestHelpers;
...
using TrainingSession = TrainingOrganizer.Training.Domain.TrainingSession;
using RecurringTrainingId = TrainingOrganizer.Training.Domain.ValueObjects.RecurringTrainingId;

namespace TrainingOrganizer.Training.Tests.Domain;
