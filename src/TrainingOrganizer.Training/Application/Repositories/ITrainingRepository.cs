...
public interface ITrainingRepository
{
    ...
    Task<PagedList<Domain.Training>> GetPagedAsync(int page, int pageSize, TrainingStatus? statusFilter, string? searchTerm, DateTimeOffset? from, DateTimeOffset? to, CancellationToken ct = default);
