...
namespace TrainingOrganizer.Membership.Infrastructure.Seeding;
...
public sealed class DevDataSeeder : IHostedService
{
    ...
    {
        var existingCount = await Members.CountDocumentsAsync(
        ...
        try
        {
            ...
            await Members.InsertManyAsync(documents, cancellationToken: cancellationToken);
