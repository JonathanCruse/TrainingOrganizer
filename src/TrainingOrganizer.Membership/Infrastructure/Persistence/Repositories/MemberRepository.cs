...
namespace TrainingOrganizer.Membership.Infrastructure.Persistence.Repositories;
...
public sealed class MemberRepository : IMemberRepository
{
    ...
    public async Task<Member?> GetByIdAsync(MemberId id, CancellationToken ct = default)
    {
        ...
        var document = await Members.Find(filter).FirstOrDefaultAsync(ct);
    ...
    public async Task AddAsync(Member member, CancellationToken ct = default)
    {
        ...
        await Members.InsertOneAsync(document, cancellationToken: ct);
    }
    ...
    public async Task UpdateAsync(Member member, CancellationToken ct = default)
    {
        ...
        var result = await Members.ReplaceOneAsync(filter, document, cancellationToken: ct);
