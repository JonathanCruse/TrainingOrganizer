...
/// </summary>
public static class DomainObjectMapper
{
    /// <summary>
    ...
    /// </summary>
    public static void AddToList<TObj, TItem>(TObj obj, string fieldName, IEnumerable<TItem> items) where TObj : class
    {
    ...
    /// </summary>
    public static void AddToHashSet<TObj, TItem>(TObj obj, string fieldName, IEnumerable<TItem> items) where TObj : class
    {
        var type = typeof(TObj);
